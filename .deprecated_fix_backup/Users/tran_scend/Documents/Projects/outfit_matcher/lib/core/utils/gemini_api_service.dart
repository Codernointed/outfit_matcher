...
class GeminiApiService {
  ...
  static Future<Map<String, dynamic>?> analyzeClothingItem(
    ...
    try {
      ...
      AppLogger.info('Gemini API error: $e');
      return null;
    }
  }
  ...
  static Future<List<MannequinOutfit>> generateMannequinOutfits(
    ...
    try {
      ...
      AppLogger.info('Error generating mannequin outfits: $e');
  ...
  static Future<String?> _generateMannequinImage(String prompt) async {
    try {
      ...
      AppLogger.info('Mannequin generation error: $e');
    }
...
''';
  ...
  static List<MannequinOutfit> _getMockMannequinOutfits(
    List<ClothingAnalysis> items,
  ) {
